...
define('ORGANIC_FARM_FREE_DOC',__('https://ovationthemes.com/docs/ot-organic-farm-free-doc','organic-farm'));
}
...
function organic_farm_guide() {
	...
	<div class="getting-started__header">
		...
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( ORGANIC_FARM_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Instructions', 'organic-farm'); ?></a>
